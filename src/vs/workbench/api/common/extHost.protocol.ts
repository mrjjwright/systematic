...
export interface ExtHostSheetShape {
	$readCell(handle: number, uri: UriComponents, row: number, col: number): Promise<UriDto<SheetCell>>;
	$writeCell(handle: number, uri: UriComponents, cell: SheetCell): Promise<void>;
}
