...
Bridge a canonical Vercel AI SDK Streaming example with a canonical vscode chat agent provider class, one running somewhere in some vscode extension

### Your output

ignore all details about the extension, just focus on a single class called TransformerAi and show the complete class in Typescript
